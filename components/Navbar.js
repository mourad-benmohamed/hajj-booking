...
const Navbar = () => {
  ...
  return (
    <header
      className={
        'dark:bg-gray-900 bg-white hidden lg:flex items-center py-6 font-["Geist"] ' +
        `${
          isScrolled
    ...
    >
      <div className="flex max-w-7xl mx-auto justify-between px-8 w-full">
        ...
        <div className="flex items-center space-x-8">
          ...
          {/* header theme button start */}
          <ThemeToggleButton />
          {/* header theme button end */}
        </div>
      </div>
    </header>
  );
